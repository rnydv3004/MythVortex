...
const featuresData: Feature[] = [
  ...
  {
    id: 5,
    icon: <span className="font-inter text-sm font-bold">SEO</span>,
    title: "SEO",
    description:
      "Strategizing and implementing SEO techniques to enhance your online visibility and organic traffic.",
  },
  {
    id: 6,
    icon: (
