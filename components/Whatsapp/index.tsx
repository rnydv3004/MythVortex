              ...
              <div className="flex w-full flex-col items-center justify-evenly lg:flex-row">
                <div className="w-full text-lg text-white lg:w-[40%]">
                  <svg
                    ...
                    height="48"
                    viewBox="0 0 48 48"
                    className="h-18 w-18 lg:h-28 lg:w-28"
                  >
                    <path
                      fill="#fff"
                  ...
                  <Link className="mb-10 mt-4 flex justify-center items-center w-[140px] rounded-md border-2 border-white px-4 py-2 text-sm font-bold hover:bg-white hover:text-[#00A884]" href={"https://wa.me/message/QLFUDPJRAHQ6D1"} target="_blank">
                    CHAT
                  </Link>
                </div>
                <div className="w-full text-lg text-white lg:w-[40%]">
