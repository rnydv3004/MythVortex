...
export default function index() {
  return (
    <section className="w-screen select-none bg-white">
      <div className="container mx-auto bg-gradient-to-t from-slate-300 via-white to-slate-50 dark:from-black dark:via-slate-600 dark:to-blackho px-8 py-14 lg:px-20">
        <h2 className="w-full max-w-[340px] text-left text-2xl font-bold text-primary">
          Who We Are
        </h2>
        <p className="mt-1 text-justify text-sm lg:text-base font-semibold text-slate-600 dark:text-slate-300">
