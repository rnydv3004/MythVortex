    ...
    <section className="w-screen bg-white select-none">
      <div className="container mx-auto grid grid-cols-2 bg-gradient-to-t from-slate-300 via-white to-slate-50 pt-14 px-8 lg:px-20">
        ...
        <div className="flex flex-col items-center justify-center gap-2 col-span-2 lg:col-span-1">
          <ul className="flex w-full max-w-[340px] flex-col gap-2 pb-10 text-base font-semibold text-slate-700">
            <li className="flex items-center gap-2 overflow-hidden rounded-md border border-slate-100 bg-white shadow">
              <svg
                className="aspect-square h-12 w-12 rounded-r-3xl bg-primary p-2 text-white"
                aria-hidden="true"
            ...
            <li className="flex items-center gap-2 overflow-hidden rounded-md border border-slate-100 bg-white shadow">
              <svg
                ...
                y="0px"
                viewBox="0 0 30 30"
                className="aspect-square h-12 w-12 rounded-r-3xl bg-primary fill-white p-2"
              >
            ...
            <li className="flex items-center gap-2 overflow-hidden rounded-md border border-slate-100 bg-white shadow">
              <span className="flex aspect-square h-12 w-12 items-center justify-center rounded-r-3xl bg-primary p-2 text-sm text-white">
                iOS
              </span>
              IOS Application
            </li>
