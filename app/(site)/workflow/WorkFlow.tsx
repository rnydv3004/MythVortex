...
export default function WorkFlow() {
    ...
    return (
    <section className="bg-slate-50 pb-16 pt-24 dark:bg-transparent md:pb-20 md:pt-28 lg:pb-24 lg:pt-32">
      <div className="container mx-auto">
        <div className="mx-4 flex flex-col gap-10 lg:flex-row lg:gap-0">
          ...
          <div
            id={workFlow[workFlowPage].title}
